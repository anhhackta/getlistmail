...
<head>
    ...
    <title>Get ListMail HoàngX</title>
                ...
                <div class="card shadow-sm">
                        ...
                        <div id="settings">
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="domain" placeholder="Ex: hotmail,gmail">
                                </div>
                                <div class="col-md-12">
                    ...
                    <div class="card-footer text-muted">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button class="btn btn-primary btn-get" type="button">Chạy</button>
                        </div>
                    </div>
                </div>
                <br>
            ...
            <div class="col-md-7 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        Kết Quả list mail tìm dược , được không :D HoàngX
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
